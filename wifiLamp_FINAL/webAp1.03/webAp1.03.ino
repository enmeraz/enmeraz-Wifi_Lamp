...
#include <ESP8266WebServer.h>
 ...
 const char* ssid   = "Test_1";         // This is the SSID that will broadcast  
 const char* password = "12345678";     // NOTE - password should be atleast 8 characters 
...
//  to the connected client  
 void updateWebpage() {  
  ...
  // Web Page Heading  
  client.println("<body><h1>Simple Web Server</h1>");  
...
//check the HTTP request of the connected client using the HTTP GET function,  

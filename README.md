...
For my final project I wanted to create a LED lamp that creates a Wifi network. I will attempt to use a ESP32 to create a wifi network for a web server using Access Points (AP). However if there is any complications then you can switch it out for a ESP8266. The following networks can be shown below.

<p align="center">
    <img src="network-esp32.png" alt="ESP32_network" width=400 hieght=400> 
    <br>
    <img src="network-ESP8622.png" alt="ESP8266_network" width=400 hieght=400> 
</p>
...
- Ports dont have to be the same, you can choose.
<p align="center">
...
<p align="center">
    <font color="grey">~ NOTE ~ all other files in the test_&setup were used to help understand how to use the microcontroller.</font> 
</p>
